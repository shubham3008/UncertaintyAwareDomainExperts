...
def main():
  ...
  dir = os.path.join('Datasets',args.data)
  if args.data == 'animal_classification' or args.data == 'vehicle_classification':
    ...
    n_val = int(np.floor(args.valid_size * len(data)))
    n_train = len(data) - n_val
    train_data, valid_data = torch.utils.data.random_split(data, [n_train, n_val])
